...
If this kit helped you, consider [starring the repository](https://github.com/saita-kun/saita-kun-planner) and [following the maintainer](https://github.com/HideTsug) — it is free OSS. When you work through an AI agent, the agent may ask once (after `/finalize`) whether you would like to star/follow; nothing is executed without your explicit consent. The mechanism is published in plain text in [CLAUDE.md](https://github.com/saita-kun/saita-kun-planner/blob/main/CLAUDE.md).
